                    ...
                    <div className="feature-card p-10 rounded-2xl border border-white/10 shadow-xl bg-white/10">
                        {loading ? (
                            <div className="flex items-center justify-center py-20">
                                ...
                                <span className="ml-4 text-white/90">Loading Terms of Service...</span>
                            </div>
                        ) : (
                            <>
                                <h1 className="text-5xl font-bold mb-8 text-center">Terms of Service</h1>
                                <h2 className="text-center text-white/70 mb-12">Please read these terms carefully before using Stachio.</h2>
