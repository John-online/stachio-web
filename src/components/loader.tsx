...
export function Loader({ isLoading, onLoadingComplete }: LoaderProps) {
  ...
  return (
    <div className={`fixed inset-0 z-50 flex flex-col items-center justify-center bg-gradient-to-b from-[#0f1419] via-[#1a2332] to-[#243447] transition-opacity duration-800 ${!isLoading ? 'opacity-0' : 'opacity-100'}`}>
